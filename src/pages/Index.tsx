...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-skoolife-light to-skoolife-white dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      ...
      {/* Main Content - Mobile optimized with iPhone safe area support */}
      <main className={`max-w-7xl mx-auto section-padding py-4 pb-32 safe-area-bottom lg:pb-8 lg:py-8 pt-4 lg:pt-4 transition-all duration-300 ${mobileMenuOpen ? 'lg:block hidden' : ''}`}>
      ...
      {/* Fixed Bottom Navigation - Native mobile app style with safe area support */}
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/98 dark:bg-gray-900/98 backdrop-blur-xl border-t border-skoolife-primary/20 dark:border-gray-700/50 shadow-2xl safe-area-bottom">
