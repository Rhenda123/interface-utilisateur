...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      ...
      <header className="hidden lg:block sticky top-0 z-50 bg-white/98 dark:bg-gray-900/98 backdrop-blur-xl border-b border-gray-200/50 dark:border-gray-700/50 shadow-sm lg:shadow-lg">
        <div className="max-w-7xl mx-auto section-padding">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <h1 className="text-responsive-2xl font-bold bg-gradient-to-r from-[#F6C103] to-[#E5AD03] dark:from-[#F6C103] dark:to-[#E5AD03] bg-clip-text text-transparent">
              SKOOLIFE
            </h1>
            
            {/* Desktop Navigation - Hidden on mobile */}
            <nav className="hidden lg:flex flex-1 justify-center">
              <div className="inline-flex bg-white dark:bg-gray-800 rounded-xl lg:rounded-2xl p-1 shadow-lg border border-[#F6C103] dark:border-gray-700 gap-1">
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden fixed inset-0 z-40 bg-white/98 dark:bg-gray-900/98 backdrop-blur-xl animate-fade-in">
          <div className="pt-20 section-padding space-y-4 sm:space-y-6 h-full overflow-y-auto">
            ...
            <div className="flex items-center gap-responsive pb-4 sm:pb-6 border-b border-yellow-100 dark:border-gray-700">
              <Avatar className="h-12 w-12 sm:h-16 sm:w-16 border-2 border-yellow-200">
                <AvatarImage src={user.avatar} alt={user.name} />
                <AvatarFallback className="bg-gradient-to-br from-yellow-400 to-yellow-500 text-gray-900 font-semibold text-lg sm:text-xl">
                  {user.initials}
                </AvatarFallback>
              </Avatar>
            ...
            <div>
              ...
              <div className="space-y-1">
                <button 
                  className="flex w-full items-center gap-responsive py-3 sm:py-4 px-3 sm:px-4 hover:bg-yellow-50 dark:hover:bg-gray-800 rounded-xl transition-all duration-200 active:scale-98 touch-manipulation"
            ...
            <div>
              ...
              <div className="flex items-center justify-between py-3 sm:py-4 px-3 sm:px-4 hover:bg-yellow-50 dark:hover:bg-gray-800 rounded-xl transition-all duration-200">
      ...
      <main className={`max-w-7xl mx-auto section-padding py-4 pb-20 lg:pb-8 lg:py-8 transition-all duration-300 ${mobileMenuOpen ? 'lg:block hidden' : ''}`}>
