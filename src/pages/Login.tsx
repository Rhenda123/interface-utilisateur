...
const Login = () => {
  ...
  if (!showForm) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-yellow-400 via-yellow-300 to-amber-400 flex flex-col justify-between p-4 relative overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center justify-center text-center relative z-10 px-4 py-8">
          {/* Logo */}
          <div className="mb-4">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 tracking-tight drop-shadow-sm">
              SKOOLIFE
            </h1>
            <div className="w-20 h-1 bg-gray-700 mx-auto mt-2 rounded-full"></div>
          </div>

          {/* Modern Student-focused Illustration - Made smaller */}
          <div className="w-64 h-48 mb-6 relative">
            <div className="w-full h-full bg-white/25 backdrop-blur-sm rounded-3xl shadow-xl flex items-center justify-center relative overflow-hidden">
              ...
              <div className="relative flex items-center justify-center">
                ...
                <div className="absolute -top-6 -left-6 w-8 h-8 bg-white/80 rounded-xl flex items-center justify-center shadow-md">
                  <Target className="w-4 h-4 text-gray-600" />
                </div>
                <div className="absolute -top-6 -right-6 w-8 h-8 bg-white/80 rounded-xl flex items-center justify-center shadow-md">
                  <Users className="w-4 h-4 text-gray-600" />
                </div>
                <div className="absolute -bottom-5 left-0 w-7 h-7 bg-yellow-200/80 rounded-lg flex items-center justify-center shadow-sm">
                  <div className="w-2.5 h-2.5 bg-gray-600 rounded-full"></div>
                </div>
                <div className="absolute -bottom-5 right-0 w-7 h-7 bg-orange-200/80 rounded-lg flex items-center justify-center shadow-sm">
                  <div className="w-2.5 h-2.5 bg-gray-600 rounded-full"></div>
                </div>
              </div>
              ...
              <div className="absolute inset-0 pointer-events-none">
                <svg className="w-full h-full" viewBox="0 0 256 192">
                  ...
                  <path d="M90 70 L128 96 L166 70" stroke="url(#lineGradient)" strokeWidth="2" fill="none"/>
                  <path d="M90 122 L128 96 L166 122" stroke="url(#lineGradient)" strokeWidth="2" fill="none"/>
                </svg>
              </div>
            </div>
          </div>

          {/* Welcome Text with better hierarchy and spacing */}
          <div className="space-y-4 max-w-xs px-2">
            ...
            {/* Key features */}
            <div className="flex justify-center space-x-4 text-gray-600 text-sm pt-2">
        ...
        {/* Action Buttons with improved spacing and sizing */}
        <div className="space-y-3 relative z-10 px-4">
          <Button 
            onClick={() => handleAuthAction(true)}
            className="w-full h-14 text-lg font-bold bg-gray-800 text-yellow-300 hover:bg-gray-700 rounded-2xl shadow-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] border-2 border-gray-700"
          >
            Se connecter
          </Button>
          ...
          <Button 
            ...
            variant="outline"
            className="w-full h-14 text-lg font-bold bg-white/20 text-gray-800 border-3 border-gray-700 hover:bg-white/30 rounded-2xl backdrop-blur-sm transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] hover:shadow-lg"
          >
            S'inscrire
          </Button>
      ...
      <Card className="w-full max-w-md border-0 shadow-2xl bg-white/95 backdrop-blur-sm animate-fade-in mx-auto">
        ...
        <CardContent className="space-y-5 px-6 pb-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  required={!isLogin}
                  className="h-11 text-base border-gray-200 focus:border-yellow-500 focus:ring-yellow-500/20 rounded-xl transition-all duration-200"
                />
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="h-11 text-base border-gray-200 focus:border-yellow-500 focus:ring-yellow-500/20 rounded-xl transition-all duration-200 pr-12"
                />
                <button
                  type="button"
            ...
            <Button 
              type="submit" 
              className="w-full h-11 text-base bg-gray-800 hover:bg-gray-700 text-yellow-300 font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
              disabled={isLoading}
            >
