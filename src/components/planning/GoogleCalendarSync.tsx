  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button className="bg-white hover:bg-green-50 text-green-600 border-2 border-green-500 hover:border-green-600 font-medium py-2 px-4 rounded-lg transition-colors duration-200 flex items-center gap-2 w-full justify-center">
