    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6">
      <Card className="border-yellow-200 dark:border-gray-700 shadow-lg bg-white dark:bg-gray-800">
        <CardContent className="p-6 sm:p-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-8">Ma To-Do List</h2>
          ...
          <div className="mb-8 space-y-4">
            <Input 
              ...
              className="border-2 border-yellow-200 dark:border-gray-600 bg-yellow-50 dark:bg-gray-700 dark:text-white rounded-lg px-4 py-3 text-lg focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400" 
            />
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <select 
                ...
                className="flex-1 border-2 border-yellow-200 dark:border-gray-600 bg-yellow-50 dark:bg-gray-700 rounded-lg px-4 py-3 font-medium text-gray-700 dark:text-gray-200 focus:ring-2 focus:ring-yellow-400 focus:border-yellow-400 focus:outline-none"
              >
                <option>Haute</option>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <Button 
                ...
                className="flex-1 bg-yellow-400 hover:bg-yellow-500 text-gray-900 px-6 py-3 rounded-lg font-semibold shadow-md transition-all duration-200 hover:shadow-lg hover:scale-105"
              >
              ...
              {editingIndex !== null && (
                <Button 
                  onClick={cancelEdit} 
                  className="flex-1 bg-gray-400 hover:bg-gray-500 text-white px-6 py-3 rounded-lg font-semibold shadow-md transition-all duration-200"
                >
                  Annuler
                </Button>
              )}
          ...
          <div className="space-y-4">
            {filteredTasks.map((task: any, index: number) => (
              <div 
                key={index} 
                className={`p-4 sm:p-6 rounded-xl border-2 transition-all duration-200 hover:shadow-md hover:scale-[1.01] ${
                  task.completed 
              ...
              >
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4">
                  <div className="flex-1">
                    <div 
                      className={`font-medium text-lg cursor-pointer transition-all duration-200 ${
                  ...
                  <div className="flex flex-row sm:flex-col items-start sm:items-end gap-3">
                    ...
                    <div className="flex gap-3">
                      ...
                      <button 
                        ...
                        className="text-sm text-red-500 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 font-medium transition-colors duration-200"
                      >
                        Supprimer
                      </button>
                    </div>
